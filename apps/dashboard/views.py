...
class DashboardView(CacheMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        credits_outstanding_trend = services.get_credits_outstanding_trend_data()
        ...
        context.update(
            {
                ...
                "credits_outstanding_trend_labels": credits_outstanding_trend['labels'],
                "credits_outstanding_trend_data": credits_outstanding_trend['data'],
                # Datos de socios
